        ...
        <div
          className={cn(
            ...
            transparent
              ...
              : "bg-black/70 backdrop-blur-md border-b border-white/10 text-white shadow-md"
          )}
        >
          <div className="mx-auto flex h-16 sm:h-20 lg:h-24 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
